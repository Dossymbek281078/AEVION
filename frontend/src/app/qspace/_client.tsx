        ...
        <aside style={S.panel}>
          ...
          {selectedUid !== null && (
            <div style={S.selBox}>
              ...
              <p style={S.hint}>
                Предмет можно перетаскивать мышью прямо в 3D. Мышь здесь нужна:
                перетаскивание и правка распознанных линий с клавиатуры пока
                недоступны — это ограничение, а не задумка. Всё остальное
                работает с клавиатуры: загрузка плана, каталог, слои, материалы,
