      ...
      */}
      ...
      <header style={S.header}>
        ...
        <p style={S.note}>
          ...
          распознаются по блокам чертежа: ширина измеряется по самому блоку, а где
          его определения в файле нет — берётся типовая. Модуль называет и это, и то,
          сколько проёмов взято по имени блока, а сколько по слою.
