 ...
 *
 * Имя этого файла шире того, что проверяют тесты выше: они гоняют Lemon
 * Squeezy и общий помощник, а не все четыре кассы через их вебхуки. Вместо
 * того чтобы сузить имя, закрываю разницу по существу.
 *
