  ...
  class Pool {
    async query(text: string, params: unknown[] = []) {
      ...
      if (/INSERT INTO "CyberDailyEntry"/i.test(text)) {
        ...
        // rowCount, как у настоящего pg. Подделка без него перестала быть
        // похожей на оригинал 18.08.2026, когда код начал считать
        // ЗАПИСАННЫЕ СТРОКИ, а не проходы функции. Мок, отвечающий не так,
        // как отвечает база, красит тесты в любой цвет, кроме верного.
