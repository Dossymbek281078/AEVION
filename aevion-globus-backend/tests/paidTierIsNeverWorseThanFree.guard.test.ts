 ...
 */
// tts убран 05.09.2026: расхождение починили в соседней ветке, мерж принёс
// починку — правило снова безусловное (пустой KNOWN оставлен под будущие
// осознанные исключения, сам сторож требует удалять пережившие причину).
