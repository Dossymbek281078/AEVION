...
const KNOWN_UNMEASURED: Record<string, string> = {
  ...
  // проверил мутациями. ПРОВЕРЕНО ФАКТОМ, а не со слов: коммит afb295d6e,
  // ветка +verify/paylinks-merge-29b, виден и в зеркале.
  // Условие исчезновения — мерж этой ветки; после него
