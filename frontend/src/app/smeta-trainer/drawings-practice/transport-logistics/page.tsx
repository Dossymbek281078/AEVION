...
Правило 300 км подтверждается: на 770 км ж/д выгоднее в 7 раз.`}
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex2} onChange={(e) => setEx2(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="400000" placeholder="400000" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
...
Решение: автоплатформа 25 т — оптимальный выбор для 25-тонн. партии.`}
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex4} onChange={(e) => setEx4(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="15300000" placeholder="15300000" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
