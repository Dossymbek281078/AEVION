    ...
    <main lang="ru" style={{ minHeight: "100vh", background: PAPER, color: INK, padding: "32px 18px 56px" }}>
      <div style={{ maxWidth: 560, margin: "0 auto", display: "flex", flexDirection: "column", gap: 28 }}>
        ...
        <WaitlistCapture
          source={source}
          tone="light"
          title={left > 0 ? "Написать вам в день запуска" : "Писать вам про турниры и обновления?"}
          description={left > 0 ? "Одно письмо на запуск и условия раннего доступа. Ничего больше." : "Письмо, когда откроются новые турниры или крупное обновление. Не чаще."}
