...
/**
 * Вынесен из папки QVenture в общие 04.09.2026.
 *
 * Замер, из-за которого: в живом каталоге 43 позиции, 25 помечены НЕ как
 * `live`, у 24 из них есть своя страница — и говорят об этом ДВЕ.
 * То есть механизм был не редким исключением, а единственным экземпляром,
 * запертым в папке одного модуля. Пока он лежал там, соседнее окно не могло
 * им воспользоваться, не притащив к себе чужой каталог.
 *
 * Показывать ли готовность на странице — решение основателя, не окон. Этот
 * компонент лишь делает решение исполнимым в одну строку: <ModuleStatusNote
 * moduleId="..." />.
 */
