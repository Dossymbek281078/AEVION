...
export const alt = "AEVION CyberChess — Tournament Hub";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function Image() {
  const chips = [
    { name: "Brackets", color: "#a78bfa", icon: "🥊" },
    { name: "Leaderboard", color: "#a78bfa", icon: "🏆" },
    { name: "Badges", color: "#a78bfa", icon: "💎" },
  ];
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ position: "absolute", bottom: 40, display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <span style={{ fontSize: 14, color: "#475569" }}>aevion.app/cyberchess/tournament</span>
      </div>
    </div>,
