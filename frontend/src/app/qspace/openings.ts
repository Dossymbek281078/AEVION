 ...
 *
 * Зачем отдельно. Из PDF и картинки приходят ТОЛЬКО стены: проёмы там
 * рисуют дугами и разрывами линий, а блоков в этих форматах нет вовсе.
 *
 * ⚠️ Прежняя редакция гласила: «и надёжно распознать их нельзя» — про все три
 * формата сразу. С 09.09.2026 это неверно: из DXF проёмы распознаются по
 * блокам, и ширина берётся из чертежа. Комментарий, объявляющий что-то
 * невозможным, стареет молча и закрывает вопрос следующему читателю.
