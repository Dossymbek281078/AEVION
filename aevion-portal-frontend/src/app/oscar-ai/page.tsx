...
export default function OscarAiPage() {
  ...
  return (
    <main style={{ padding: 24, maxWidth: 980 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 26, marginBottom: 6 }}>Oscar AI</h1>
          <p style={{ color: "#666", marginTop: 0 }}>
            Участие в кино-коллаборациях: создание защищённого объекта (через QRight).
          </p>
        </div>
      ...
      >
        ...
        <form onSubmit={submit} style={{ display: "grid", gap: 10 }}>
          <input
            ...
            placeholder="Название (например 'Кибер-детектив: трейлер')"
            style={{
              padding: 10,
              borderRadius: 8,
