...
const AWAITING_FOUNDER: Record<string, string> = {
  ...
  qspace: "3D-модельер помещений, MVP 07.09.2026: просмотр и примерка бесплатны намеренно; монетизация этапа 2 — экспорт слоёв/сметы/GLB. Предложено $19/мес за экспорт",
