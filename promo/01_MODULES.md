...
### ⭐ QVenture (NEW, 2026-07) — AI Investment Analyst

- **Что это:** новая планета для англоязычного инвест-рынка. Превращает описание любого бизнеса в любой сфере в fund-grade скрининг-мемо: прозрачный quant-скор 0–100 по 8 факторам (на базе knowledge-base из 18 секторов) + совет из 4 ролей (учёный · дата-аналитик · экономист · юрист через QCoreAI на живом Anthropic) + конкретная стратегия входа (тикет, транши, вилка оценки, risk-adjusted MOIC/IRR, доля через fractional-Kelly).
- **Бенефит:** инвестор (ангел / микро-VC / скаут / синдикат) получает воспроизводимую due-diligence за секунды; детерминированное ядро — цифры доказуемы, не галлюцинация.
- **Привилегия покупателя:** полный инвест-воркфлоу под ключ — анализ → сравнение двух сделок side-by-side → watchlist → экспорт (PDF-мемо + PDF-сравнение) → публичный шеринг с OG-превью.
- **Статус:** ЖИВОЕ на проде `aevion.vercel.app/qventure`, Postgres, prod-smoke 35/35, платный модуль ($39/мес, full/enterprise). Демо в один клик: `/qventure/a/demo-neurodx`.
...
| Consumer | 11+ | 8+ retention-products в проде; +QVenture (AI due-diligence) live |
...
Новейшая планета: **QVenture — AI Investment Analyst** (live 2026-07, `aevion.vercel.app/qventure`).

---

— редакция 2026-07-09, AEVION
