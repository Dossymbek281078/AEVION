...
export const alt = "AEVION CyberChess — таблица лидеров CPI";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function Image() {
  const chips = [
    { name: "Top players", color: "#a78bfa", icon: "🏆" },
    { name: "Per-factor", color: "#a78bfa", icon: "🎯" },
    { name: "Trends", color: "#a78bfa", icon: "📈" },
  ];
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 22, color: "#64748b", textAlign: "center", marginBottom: 52, maxWidth: 980 }}>
        Рейтинг по любому из 9 факторов качества
      </div>
      ...
      <div style={{ position: "absolute", bottom: 40, display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <span style={{ fontSize: 14, color: "#475569" }}>aevion.app/cyberchess/cpi/leaderboard</span>
      </div>
    </div>,
