    ...
    <main>
      ...
      <ProductPageShell maxWidth={860}>
        ...
        {/* Приём адресов. До 19.08.2026 QRight был единственным модулем очереди
            ...
            без неё после 10 сентября не ответить, откуда пришли люди. */}
        <div style={{ marginBottom: 24 }}>
          <WaitlistCapture
            source="qright"
            tone="dark"
            title="Написать вам в день запуска"
            description="Реестр открыт уже сейчас. Одно письмо на запуск бюро 10 сентября и условия раннего доступа."
          />
        </div>
