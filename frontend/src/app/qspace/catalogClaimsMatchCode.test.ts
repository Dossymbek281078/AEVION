...
describe("описание QSpace в реестре не расходится с кодом", () => {
  ...
  it("описание не обещает того, чего модуль не делает", () => {
    ...
    expect(text, "описание не называет, что ширина проёма ТИПОВАЯ, а не из файла")
      .toMatch(/ширина.{0,40}типова/i);
  ...
  it("каждая заметная возможность модуля названа в описании", () => {
    const clientSrc = readFileSync(path.join(__dirname, "_client.tsx"), "utf8");
