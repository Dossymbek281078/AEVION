...
const dict: Record<string, string> = {
  ...
  // Пара с ПРЕЖНИМ числом удаляется вместе со сменой счётчика: словарь
  // виден человеку, и устаревшее число в нём — такое же заявление, как
  // на странице. Держать обе пары «на всякий случай» значит хранить ложь.
  "42 product nodes": "42 \u043f\u0440\u043e\u0434\u0443\u043a\u0442\u043e\u0432\u044b\u0445 \u0443\u0437\u043b\u0430",
