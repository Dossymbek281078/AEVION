  ...
  return (
    <main
      style={{
        minHeight: "100vh",
        background:
          "radial-gradient(circle at 25% 0%, rgba(94,234,212,0.18), transparent 55%), linear-gradient(180deg, #0f172a 0%, #1e293b 60%, #0f172a 100%)",
        color: "#f8fafc",
      ...
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <header style={{ marginTop: 18, marginBottom: 20 }}>
          <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: 6, color: "#5eead4", textTransform: "uppercase" }}>
            {t("wishlistPage.kicker")}
          </div>
          <h1 style={{ fontSize: 40, fontWeight: 900, letterSpacing: -1.2, lineHeight: 1.05, marginTop: 14, marginBottom: 8 }}>
            {t("wishlistPage.headline")}
          </h1>
          <div style={{ fontSize: 15, color: "#cbd5e1", lineHeight: 1.55, maxWidth: 640 }}>{t("wishlistPage.lede")}</div>
        </header>
        ...
        >
          <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: 4, color: "#5eead4", textTransform: "uppercase" }}>
            {t("wishlistPage.cta.kicker")}
          </div>
          <div style={{ fontSize: 20, fontWeight: 900, marginTop: 6, lineHeight: 1.25 }}>{t("wishlistPage.cta.title")}</div>
          <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
            <Link href="/bank/savings" style={ctaPrimary}>{t("wishlistPage.cta.savings")} →</Link>
            <Link href="/bank/budget" style={ctaSecondary}>{t("wishlistPage.cta.budget")} →</Link>
          </div>
        </section>
