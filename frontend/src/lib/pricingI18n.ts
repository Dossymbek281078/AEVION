...
const baseDict: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    "edu.tier.university.body": "Sponsorship-программа: тариф Full на до 200 seats для всего вуза, plus on-prem развёртывание для исследовательских лабораторий по запросу.",
    ...
    "error.retryHint": "Обновите страницу или попробуйте позже. Подробность — в журнале браузера.",
  ...
  en: {
    ...
    "edu.tier.university.body": "Sponsorship: the Full tier for up to 200 university-wide seats, plus on-prem deployment for research labs by request.",
    ...
    "error.retryHint": "Refresh the page or try again later. The details are in the browser console.",
