...
const SMOKES = [
  ...
  // Сверка каталога с ЖИВЫМИ карточками оплаты: цена и периодичность у каждого
  // из 16 товаров должны совпадать с тем, что увидит покупатель в кассе.
  //
  // Добавлен 29.08.2026, и повод стоит записать. Скрипт существует с 26.07,
  // хорош, и не запускался НИКЕМ: ни в наборе, ни в package.json, ни в CI
  // (проверено грепом с контролем — другие `node scripts/` в workflow есть).
