...
<script src="https://aevion.app/api-backend/api/build/public/widget.js" defer></script>`}</Pre>
        ...
        <Section title="2 · Partner JSON API" anchor="api">
          ...
          <Pre>{`curl https://aevion.app/api-backend/api/build/public/v1/vacancies?limit=10 \\
  ...
  "data": {
    ...
    "offset": 0
        ...
        <Section title="3 · RSS feed" anchor="rss">
          ...
          <Pre>{`https://aevion.app/api-backend/api/build/public/rss/vacancies.xml
https://aevion.app/api-backend/api/build/public/rss/vacancies.xml?city=Astana
https://aevion.app/api-backend/api/build/public/rss/vacancies.xml?skill=welding`}</Pre>
        </Section>
