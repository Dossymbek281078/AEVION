...
**Когда ИИ-инструменты становятся товаром, дефицитом становится не инструмент, а место, где живёт пользователь.** Несколько структур уже дают ИИ «для всего» — следующий слой не сотня вкладок, а самодостаточные среды-«планеты», внутри которых происходит вся работа человека. Кто построит первую связную — владеет всей сессией пользователя. **AEVION — первая такая планета, на базе Anthropic:** внутри её ареала есть всё, и уходить никуда не нужно. Открытая по дизайну — можно подключить Amazon и другие площадки, можно строить свои под-миры (пользователи или сам Anthropic). Полный тезис — `24_PLANET_THESIS.md`.
