...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T12:32:32.753Z — window=10min commits=21 branches=7 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 15 | api-explorer, qsocial, sdk, veilnetx-ledger, seo+docs | 76 seconds ago | feat(api-explorer): /api-explorer/sdk — 7th page, live SDK playground |
| `feat/capstone-cases` | C:/Users/user/aevion-smeta-trainer | 1 | smeta-trainer | 11 seconds ago | feat(smeta-trainer): capstone-кейсы — коттедж/кафе/автомойка (батч 29) |
| `feat/lifts-smart-asbestos` | (no worktree) | 1 | smeta-trainer | 8 minutes ago | feat(smeta-trainer): smart-home + демонтаж асбеста (батч 28) |
| `feat/qzone-block2-2026-05-12` | (no worktree) | 1 | qai | 7 minutes ago | feat(qai): real-time streaming UI — chunks arrive word-by-word, persona selec… |
| `feat/qzone-block5-2026-05-12` | C:/Users/user/aevion-core/frontend-qcore | 1 | coord | 9 minutes ago | chore(coord): WIP heartbeat 17:24 UTC — SDK v0.3 + version page + tests on main |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | veilnetx-ledger-smoke | 53 seconds ago | test(veilnetx-ledger-smoke): assert invalid_currency + meta_too_large rejections |
| `main` | C:/Users/user/aevion-core | 1 | sdk | 38 seconds ago | docs(sdk): comprehensive @aevion/catalog-client cookbook (318 lines) |

_Last refresh: 2026-05-12T12:32:32.753Z_
