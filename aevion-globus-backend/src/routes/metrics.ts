...
// getQtradeMetrics is not yet exported from qtrade; provide a stub so the
// metrics endpoint still compiles and returns zeros for qtrade counters.
function getQtradeMetrics() {
  return { accounts: 0, transfers: 0, operations: 0, idemCache: 0 };
}
