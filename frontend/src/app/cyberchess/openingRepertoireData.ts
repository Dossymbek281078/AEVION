...
export function defaultRepertoire(): RepertoireBranch[] {
  ...
  return [
    make({
      ...
      notes: "Классическая итальянская партия — надёжное построение за белых.",
      attempts: 0,
      successes: 0,
    ...
    make({
      ...
      notes: "Надёжная схема за чёрных против 1.e4. Слона на f5 выводите до хода e6.",
      attempts: 0,
      successes: 0,
    ...
    make({
      ...
      notes: "Очень острый вариант — нужна конкретная подготовка.",
      attempts: 0,
      successes: 0,
    ...
    make({
      ...
      notes: "Закрытая позиционная игра. Цель — атака меньшинства.",
      attempts: 0,
      successes: 0,
