...
const APIS = [
  ...
  },
  {
    ...
    color: "#a78bfa",
    href: "/qpaynet",
    desc: "Embedded payments — KZT wallets, P2P transfers (0.1% fee), tracked payment requests with HMAC webhooks (5-attempt retry queue), merchant API key, set-once webhook subscriptions, KYC stub for РК compliance, embeddable pay widget, CSV exports.",
    endpoints: [
      "POST /api/qpaynet/wallets",
      "POST /api/qpaynet/transfer",
      "POST /api/qpaynet/requests",
      "POST /api/qpaynet/webhook-subs",
      "POST /api/qpaynet/webhooks/test",
