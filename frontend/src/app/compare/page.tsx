    ...
    rows: [
      {
        ...
        weaker:
          "У Perplexity ответы сводит chair-модель — это смысловой синтез, у нас лексические эвристики. На живых провайдерах наш консилиум ни разу не прогонялся: локально агенты возвращали одинаковую заглушку, то есть качество не измерено. Ключи подписи на проде не настроены, поэтому в чеке пока только хеш.",
        stronger:
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "48px 20px 80px" }}>
        ...
        >
          <p style={{ margin: 0, fontSize: 15.5, lineHeight: 1.65, color: PALETTE.ink }}>
            ...
            нет поддержки, нет интеграций, нет истории инцидентов. Для бизнеса это весит больше любой
