...
/**
 * Сценарии «batch E» — обоснование коэффициентов условий (урок 2.6, продолжение).
 * Отслеживаются в аналитике куратора вместе с batch D как «новые детекторы».
 */
export const BATCH_E_SCENARIOS: string[] = [
  "coef-unjustified",
];
