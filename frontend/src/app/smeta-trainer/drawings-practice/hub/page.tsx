...
const MODULES: Module[] = [
  ...
  { id: "kazakh-yurta-museum-complex", category: "special", href: "/smeta-trainer/drawings-practice/kazakh-yurta-museum-complex", icon: "🛖", title: "Этнокомплекс «Юрта Великой Степи»",  subtitle: "8 yurts UNESCO 2014, kerege+uyk+shanyrak, ремесленные мастерские, ICOMOS Living Heritage", level: "L5", exercises: 4,  color: "amber"   },
  { id: "glacier-monitoring-station", category: "special", href: "/smeta-trainer/drawings-practice/glacier-monitoring-station", icon: "🧊", title: "Glacier Monitoring Tian Shan",     subtitle: "Туюк-Су с 1957, -0.8 м/год, mass balance stakes + IPR + UAV + ICESat-2, WGMS + GLIMS", level: "L5", exercises: 4,  color: "cyan"    },
  { id: "sacred-pilgrimage-mausoleum", category: "special", href: "/smeta-trainer/drawings-practice/sacred-pilgrimage-mausoleum", icon: "🕌", title: "Мавзолей Ясави UNESCO 1M/yr",   subtitle: "Туркестан XIV в Тамерлан, 1M pilgrims/year, microclimate 14-22 °C, UNESCO + ICOMOS Burra Charter", level: "L5", exercises: 4,  color: "yellow"  },
