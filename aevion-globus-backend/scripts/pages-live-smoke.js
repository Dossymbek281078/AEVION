...
const PAGES = [
  ...
  // Публичная страница, которую открывает аудитор TikTok при проверке
  // Content Posting API. Её тихая поломка = отказ в доступе к публикации.
  // Проверена живой (200, 31KB) 2026-08-10.
  "/tiktok-publisher",
];
