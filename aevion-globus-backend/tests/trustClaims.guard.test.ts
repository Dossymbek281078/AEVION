...
const ALLOWED_BACKEND: Array<{ fragment: string; reason: string }> = [
  // 20.09.2026: оба прежних исключения сняты вместе с самими текстами —
  // демо-отзыв в trust.ts (публиковать выдуманные отзывы под рекламу нельзя)
  // и цитата кейса в cases.ts с отставной ценой (убрана веткой b9). Список
  // пуст намеренно; новое исключение — только с причиной.
];
