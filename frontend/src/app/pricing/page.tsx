  ...
  return (
    <ProductPageShell maxWidth={1280}>
      ...
      >
        ...
        <div
          style={{
            // Было "1fr 1fr" — жёсткие две колонки, которые не складываются на
            // телефоне: 200px + 157px + зазор 24 = 381 при контейнере 286, и
            // страница /pricing разъезжалась вбок на 433 при экране 390.
            // Панель СМЕТА с кнопкой «Оплатить смету» уезжала за правый край.
            //
            // auto-fit, а не auto-fill: детей ровно два, лишняя дорожка
            // схлопывается в 0, поэтому на десктопе всё остаётся как было.
            // Замер до/после на живой странице: 1440 и 1280 — 576px 576px,
            // 1024 — 448px 448px, 768 — 320px 320px (без изменений);
            // 390 — одна колонка 286px, документ 433 -> 390.
