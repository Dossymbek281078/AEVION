        ...
        <section className="space-y-6">
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex2T} onChange={(e) => setEx2T(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="150" placeholder="150" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
...
Если ПИР (λ=0.022): δ = 3.3×0.022 = 73 мм → 80 мм (дороже, но тоньше)`}
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex4Saved} onChange={(e) => setEx4Saved(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="825000" placeholder="825000" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
