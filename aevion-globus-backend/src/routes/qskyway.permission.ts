...
import { PERMISSION_VIENNA } from "./qskyway.permission.vienna";
...
export const PERMISSION: Record<string, CityPermission> = { tokyo: PERMISSION_TOKYO, astana: PERMISSION_ASTANA, singapore: PERMISSION_SINGAPORE, amsterdam: PERMISSION_AMSTERDAM, berlin: PERMISSION_BERLIN, vienna: PERMISSION_VIENNA };
