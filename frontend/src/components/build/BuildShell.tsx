...
const SHELL_SKIN: Record<ShellTheme, {
  ...
  light: {
    root: "bg-paper text-paper-ink",
    header: "border-paper-rule bg-paper/85",
    menuBtn: "border-paper-rule-soft bg-white text-paper-ink-soft hover:bg-paper-2",
    logoSub: "text-paper-ink-faint",
    navActive: "bg-paper-ink text-white",
    navIdle: "text-paper-ink-soft hover:bg-paper-2 hover:text-paper-ink",
    moreBtn: "text-paper-ink-soft hover:bg-paper-2 hover:text-paper-ink",
    gear: (active) => `border-paper-rule-soft text-paper-ink-soft hover:bg-paper-2 ${active ? "bg-paper-2" : ""}`,
    footer: "border-paper-rule text-paper-ink-faint",
    footerLink: "hover:text-paper-ink",
    drawer: "border-paper-rule bg-paper-card",
    drawerBar: "border-paper-rule",
    drawerBtn: "border-paper-rule-soft bg-white text-paper-ink-soft hover:bg-paper-2",
    drawerActive: "bg-paper-teal/12 text-paper-teal-deep",
    drawerIdle: "text-paper-ink-soft hover:bg-paper-2",
    bottomNav: "border-paper-rule bg-paper/95",
    bottomActive: "text-paper-teal-deep",
    bottomIdle: "text-paper-ink-faint hover:text-paper-ink",
  },
};
