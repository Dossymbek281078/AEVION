 ...
 * читателя, но перед запуском 10.09 его стоит вычитать.
 */
...
const EN = {
  ...
  "cmp.music": "Music",
  "cmp.threeD": "3D models",
  "cmp.hosting": "Hosting",
  "cmp.compareLink": "How we look next to Bolt, Lovable, v0 and Replit →",
  "value.priceNote": "Prices are the services' public tariffs as of September 2026. We don't promise \"many times cheaper\": the win is not the subscription price — it's that each step's result lands in the same project as the next one.",
  "howto.title": "How to work with AI — two minutes",
  "howto.body": "Context instead of a command, a plan before the work, checking the answer by running it, and your own tools. The same habits this studio is built around.",
  ...
  "howto.transcript": "Read it instead of watching (full transcript)",
  "cmp.offNow": "not working right now — see the state above",
  ...
  "link.tooOften": "Too many attempts. Please wait ten minutes and try again.",
  ...
  "store.total": "Total",
  "hero.sub": "Build and deploy apps with AI. No GitHub or cloud accounts needed — and no sign-up: your first project builds right away.",
  ...
  "proj.storageBlocked": "Your browser blocks site storage, so we cannot tell your projects apart from other visitors' in the same situation: what you create here can be seen — and deleted — by them. Allow storage for this site, or sign in.",
  ...
  "proj.confirmDelete": "Delete this project? Files and — if one was created — the database with all its data are removed for good. A site you published stays live at its address: write to us if it should come down too.",
  ...
  "status.live": "Live",
  "status.failed": "Error",
  "stack.next": "React with a server and API",
  "stack.express": "REST API in TypeScript",
  "stack.static": "HTML/CSS/JS — instant preview and click-to-edit",
  "stack.react": "Vite + React, preview in the browser",
  "stack.python": "FastAPI / Flask backend",
  ...
  "proj.openIde": "Open the editor",
  "proj.delete": "Delete",
  "proj.redeploy": "⟳ Redeploy needed",
  "snip.copied": "Copied!",
  "snip.copy": "Copy",
  "err.projLoad": "Projects did not load — refresh the page or come back in a minute",
  "err.snipLoad": "Snippets did not load — try refreshing",
...
const RU: Record<Key, string> = {
  ...
  "cmp.voice": "Озвучка",
  "cmp.music": "Музыка",
  "cmp.threeD": "3D-модели",
  "cmp.hosting": "Хостинг",
  "cmp.compareLink": "Как мы выглядим рядом с Bolt, Lovable, v0 и Replit →",
  "value.priceNote": "Цены — публичные тарифы сервисов на сентябрь 2026. Мы не обещаем «в разы дешевле»: выигрыш здесь не в цене подписки, а в том, что результат одного шага сразу лежит в том же проекте, что и следующий.",
  "howto.title": "Как работать с ИИ — две минуты",
  "howto.body": "Контекст вместо команды, план до работы, проверка ответа делом и свои инструменты. Те же привычки, вокруг которых собрана эта студия.",
  ...
  "howto.transcript": "Прочитать вместо просмотра (полная расшифровка)",
  "cmp.offNow": "сейчас не работает — состояние выше",
  ...
  "link.tooOften": "Слишком много попыток. Подождите десять минут и повторите.",
  ...
  "store.total": "Итого",
  "hero.sub": "Собирайте и публикуйте приложения с ИИ. Без GitHub и облачных аккаунтов — и без регистрации: первый проект соберётся сразу.",
  ...
  "proj.storageBlocked": "Браузер блокирует хранилище сайта, поэтому мы не отличаем ваши проекты от чужих в такой же ситуации: созданное здесь могут увидеть и удалить другие. Разрешите хранилище для сайта или войдите.",
  ...
  "proj.confirmDelete": "Удалить проект? Вместе с ним исчезнут файлы и — если база создавалась — сама база со всеми данными. Вернуть будет нельзя. Опубликованный сайт при этом остаётся доступным по своему адресу — напишите нам, если его тоже нужно снять.",
  ...
  "stack.next": "React с сервером и API",
  "stack.express": "REST API на TypeScript",
  "stack.static": "HTML/CSS/JS — мгновенное превью и правка кликами",
  "stack.react": "Vite + React, превью в браузере",
  "stack.python": "FastAPI / Flask — бэкенд на Python",
  ...
  "proj.openIde": "Открыть редактор",
  "proj.delete": "Удалить",
  "proj.redeploy": "⟳ Нужна перевыкатка",
  "snip.copied": "Скопировано!",
  "snip.copy": "Копировать",
  "err.projLoad": "Проекты не загрузились — обновите страницу или зайдите через минуту",
  "err.snipLoad": "Сниппеты не загрузились — попробуйте обновить",
...
const KK: Record<Key, string> = {
  ...
  "cmp.voice": "Дыбыстау",
  "cmp.music": "Ән-күй",
  "cmp.threeD": "3D-модельдер",
  "cmp.hosting": "Хостинг қызметі",
  "cmp.compareLink": "Bolt, Lovable, v0 және Replit қатарында қалай көрінеміз →",
  "value.priceNote": "Бағалар — сервистердің 2026 жылғы қыркүйектегі жария тарифтері. «Бірнеше есе арзан» деп уәде бермейміз: ұтыс жазылым бағасында емес — әр қадамның нәтижесі келесісімен бір жобада жатады.",
  "howto.title": "Жасанды интеллектпен қалай жұмыс істеу керек — екі минут",
  "howto.body": "Бұйрықтың орнына контекст, жұмысқа дейін жоспар, жауапты іспен тексеру және өз құралдарың. Осы студия сол әдеттердің айналасында жиналған.",
  ...
  "howto.transcript": "Қараудың орнына оқу (толық мәтін)",
  "cmp.offNow": "қазір жұмыс істемейді — күйі жоғарыда",
  ...
  "link.tooOften": "Тым көп әрекет. Он минут күтіп, қайталаңыз.",
  ...
  "store.total": "Барлығы",
  "hero.sub": "Қолданбаларды ЖИ көмегімен жинаңыз және жариялаңыз. GitHub пен бұлттық тіркелгісіз — және тіркелусіз: алғашқы жобаңыз бірден жиналады.",
  ...
  "proj.storageBlocked": "Браузер сайт жадын бұғаттайды, сондықтан біз сіздің жобаларыңызды дәл сондай жағдайдағы басқалардікінен ажырата алмаймыз: мұнда жасағаныңызды олар көре де, жоя да алады. Сайтқа жадты рұқсат етіңіз немесе кіріңіз.",
  ...
  "proj.confirmDelete": "Жобаны жою керек пе? Файлдар және — егер дерекқор жасалған болса — дерекқор барлық деректерімен бірге қайтарымсыз жойылады. Жарияланған сайт өз мекенжайында қолжетімді болып қала береді — оны да өшіру керек болса, бізге жазыңыз.",
  ...
  "status.draft": "Қаралама",
  "status.building": "Құрастырылуда...",
  "status.live": "Тірі",
  "status.failed": "Қате",
  "stack.next": "Сервері мен API-і бар React",
  "stack.express": "TypeScript тіліндегі REST API",
  "stack.static": "HTML/CSS/JS — лезде алдын ала қарау және басып өңдеу",
  "stack.react": "Vite + React, браузерде алдын ала қарау",
  "stack.python": "FastAPI / Flask — Python сервері",
  "modal.name": "Жоба атауы *",
  "modal.desc": "Сипаттама",
  "modal.stack": "Технологиялар стегі",
  "modal.cancel": "Болдырмау",
  "modal.create": "Жоба жасау",
  "modal.creating": "Жасалуда...",
  "proj.openIde": "Өңдегішті ашу",
  "proj.delete": "Жою",
  "proj.redeploy": "⟳ Қайта жариялау қажет",
  "snip.copied": "Көшірілді!",
  "snip.copy": "Көшіру",
  "err.projLoad": "Жобалар жүктелмеді — бетті жаңартыңыз немесе бір минуттан кейін қайта келіңіз",
  "err.snipLoad": "Сниппеттер жүктелмеді — жаңартып көріңіз",
