...
const KNOWN_WITHOUT: Record<string, string> = {
  // 08.09.2026: cyberchess УБРАН отсюда — механизм появился. По решению
  // основателя «Глубокий анализ» (Stockfish 17.1 NNUE) закрыт за Pro $19
  // через checkAppAccess("cyberchess"); игра, задачи, коуч, лёгкий анализ и
  // задача дня остались бесплатными. Список снова пуст — и это правильное
