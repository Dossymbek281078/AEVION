...
const PRESETS: { kind: AppliedCoefficient["kind"]; label: string; value: number; note: string }[] = [
  { kind: "действующий-объект", label: "Действующий объект", value: 1.15, note: "СН РК 8.02-05, прил. (коэф. условий)" },
  { kind: "стеснённые",         label: "Стеснённые условия",  value: 1.15, note: "СН РК 8.02-05, прил. (коэф. условий)" },
  { kind: "социальный-объект",  label: "Соц. объект",         value: 1.10, note: "СН РК 8.02-07" },
  { kind: "высота",             label: "Высота > 15 м",       value: 1.25, note: "СН РК 8.02-05, прил. (коэф. условий)" },
  { kind: "охранные-зоны",      label: "Охранная зона",       value: 1.25, note: "СН РК 8.02-05, прил. (коэф. условий)" },
