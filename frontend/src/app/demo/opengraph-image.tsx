...
export const alt = `AEVION live ecosystem demo — ${MODULE_NODES} nodes, one trust pipeline`;
    ...
    (
      ...
      >
        ...
        >
          ...
          <div style={{ color: "#a78bfa", display: "flex" }}>~a dozen feature-complete · 1 pipeline</div>
        </div>
      </div>
    ),
    { ...size },
