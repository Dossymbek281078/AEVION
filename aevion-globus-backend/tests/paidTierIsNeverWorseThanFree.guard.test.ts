...
const KNOWN: Record<string, string> = {
  // Пусто — и это правильное состояние. Здесь числился tts (free 100000 против
  // pro 30000, вынесено основателю 28.08.2026). Инверсия убрана 01.09.2026:
  // платному подняли до уровня бесплатного. Это ПОЛ, а не ответ — во сколько
  // раз больше, основатель ещё решает, — но «платный не хуже бесплатного»
  // решением не является, и держать это в исключениях больше незачем.
}
