  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 16px" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-end" }}>
              {/* Кнопки НЕТ, если товара нет в каталоге.
                  ...
                  человек видел бы кнопку с ценой, нажимал и не попадал никуда.
                  ...
                  Цена берётся только из каталога: зашитое рядом число — второй
                  источник, который однажды разойдётся с настоящей ценой.
                  15.09.2026: DevHub — одно из пяти приложений новой лестницы
                  сроков; ссылка ведёт на /pricing?app=devhub#apps (выбор срока и
                  касса), цена в подписи — месяц на самом коротком сроке (1 месяц):
                  на длинных сроках месяц дешевле, и это видно на странице цен. */}
              {STUDIO_PRO ? (
              <a
                href={STUDIO_PRO.href}
                // Выбор срока на /pricing; событие оставлено здесь, чтобы видеть,
                // сколько человек пошло покупать именно со страницы DevHub.
                onClick={() => track({ type: "checkout_start", tier: "studio-pro", source: "devhub", meta: { processor: STUDIO_PRO.processor } })}
                style={{
              ...
              {/* Правда, которая нужна человеку ДО оплаты, а не после.
                  ...
                  он заплатит и увидит бесплатный тариф. Замер 29.08.2026
        ...
        {/* Провенанс ИИ-генераций — продающая особинка платного DevHub (спека Монетизации
              ...
              {DEVHUB_EXAMPLES.map((ex) => {
                ...
                <div key={ex.url} style={{ border: "1px solid #e2e8f0", borderRadius: 10, padding: "12px 14px", display: "flex", flexDirection: "column", gap: 8 }}>
                  ...
                  <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                    ...
                    <button
                      onClick={() => { setIdeaPrompt(exT.prompt); ideaFieldRef.current?.scrollIntoView({ behavior: "smooth", block: "center" }); }}
