...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    body: "Любой промокод теперь ограничен максимум 50% от суммы заказа — защита от случайно слишком щедрого фикс-кода, который мог бы сделать подписку бесплатной.",
    scope: "pricing",
  },
  {
    date: "2026-07-22",
    kind: "changed",
    title: "Обновлены тарифы AEVION",
    body: "Lite $19→$24, Medium $29→$39, Full $49→$89, Universe $149.99→$249.99 — платформа даёт больше 30+ продуктов, поэтому цена бандла поднята выше топовых тарифов отдельных AI-сервисов. Отдельные продукты с прямым конкурентом (CyberChess, QCoreAI как отдельная AI-подписка) наоборот подешевели до $9.99/мес — вдвое ниже прямого конкурента, пока строим трэкшн.",
    scope: "pricing",
  },
  {
    date: "2026-07-22",
    kind: "added",
    title: "Реальный лимит токенов QCoreAI по тарифу",
    body: "Месячный лимит токенов теперь реально считается по каждому платному тарифу, плюс отдельный меньший лимит на топовые/самые дорогие AI-модели — обычные модели остаются доступны без ограничений.",
    scope: "qcoreai",
  },
  {
    date: "2026-04-29",
