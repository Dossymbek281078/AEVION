      ...
      <div className="print-root">
        ...
        <div className="pillars">
          ...
          <div className="pillar">
            ...
            <div className="body">DevHub (14 возможностей live из 16: Monaco IDE, Postgres, GitHub, Cloudflare Pages + домен, ElevenLabs, изображения, видео, e-mail, SMS, WhatsApp; Railway не реализован, Vercel ждёт токен) · QCoreAI (5+ AI-провайдеров) · QBuild · Bureau v2.</div>
          </div>
          <div className="pillar">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>Dev / DevHub</td><td>DevHub (14 capabilities live / 16), QCoreAI (5+ providers, 230 routes), QBuild (60+ endpoints), Bureau v2</td><td>23 vitest · 364 vitest · 30/30 ATS tests</td></tr>
        ...
        <ul>
          ...
          <li><strong>14 возможностей DevHub live</strong> — 36+ месяцев комплаенс-работы для нового игрока.</li>
