...
export const alt = "AEVION CyberChess — тренировки";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function Image() {
  const chips = [
    { name: "Daily Drill", color: "#34d399", icon: "💪" },
    { name: "Variant", color: "#34d399", icon: "🎲" },
    { name: "+25 AEV", color: "#34d399", icon: "🪙" },
  ];
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 22, color: "#64748b", textAlign: "center", marginBottom: 52, maxWidth: 980 }}>
        План на день · тренировка слабой стороны · вариант дня · бонус AEV
      </div>
      ...
      <div style={{ position: "absolute", bottom: 40, display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <span style={{ fontSize: 14, color: "#475569" }}>aevion.app/cyberchess/training</span>
      </div>
    </div>,
