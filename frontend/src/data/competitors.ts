...
export const COMPARISONS: ModuleComparison[] = [
  ...
  {
    moduleId: "lifebox",
    module: "LifeBox — капсула с письмом в будущее",
    page: "/lifebox",
    category: "отложенные послания и цифровое наследие",
    rivals: [
      { name: "FutureMe", url: "https://futureme.org", strength: "двадцать лет работы и репутация: письмо действительно приходит через годы" },
      { name: "Google Inactive Account Manager", url: "https://myaccount.google.com/inactive", strength: "срабатывает от неактивности аккаунта, а не от даты — и это встроено в почту, которой человек уже пользуется" },
      { name: "Apple Legacy Contact", url: "https://support.apple.com/en-us/HT212360", strength: "доступ наследника к данным на уровне операционной системы" },
    ],
    weWin: [
      {
        text: "Содержимое действительно скрыто до срока: закрытая капсула не отдаётся ни в списке, ни при прямом запросе",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: все ответы с капсулой идут через publicView (content: null, пока заперта), а прямой запрос до срока возвращает 403 — просмотрены все восемь мест, где модуль что-либо отдаёт",
      },
      {
        text: "Капсулу можно править, пока она заперта, и нельзя после — правило видно в самом интерфейсе API",
        basis: "design",
        evidence: "PATCH /capsules/:id заявлен как «edit only while locked»",
      },
      {
        text: "Ни регистрации, ни почты: капсула живёт по псевдониму, который выбирает сам человек",
        basis: "design",
        evidence: "доступ по alias, аккаунт не требуется",
      },
    ],
    weLose: [
      {
        text: "Доступ защищён только знанием псевдонима — ни пароля, ни второго фактора. Кто угадал строку, тот и прочитал",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: единственная проверка — совпадение alias, допускаются любые буквы, цифры, точка, дефис и подчёркивание до 64 символов",
      },
      {
        text: "Мы не обещаем и не можем обещать доставку через двадцать лет: у FutureMe за этим стоит двадцатилетняя история, у нас — нет",
        basis: "design",
        evidence: "срок жизни продукта меньше типичного срока капсулы",
      },
      {
        text: "Открытие по дате, а не по событию: сценарий «если со мной что-то случится» закрывают Google и Apple, а не мы",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
    ],
    verdict:
      "Мы лучше для письма себе на понятный срок без регистрации. Для настоящего цифрового наследия — механизмы Google и Apple, они привязаны к аккаунту и к событию.",
    surveyedAt: "2026-07-28",
    sources: ["src/routes/lifebox.ts"],
  },

  {
    moduleId: "qchaingov",
    module: "QChainGov — предложения и голосование",
    page: "/qchaingov",
    category: "инструменты управления сообществом и голосования",
    rivals: [
      { name: "Snapshot", url: "https://snapshot.org", strength: "стандарт голосований в web3: вес голоса по токену, подписи кошельком, тысячи организаций" },
      { name: "Aragon", url: "https://aragon.org", strength: "решение исполняется само: казна и права управляются контрактом, а не человеком" },
      { name: "Loomio / Decidim", url: "https://loomio.com", strength: "зрелые инструменты обсуждения и согласия для организаций без блокчейна" },
    ],
    weWin: [
      {
        text: "Полный жизненный цикл предложения в одном API: создать, открыть, собрать голоса, закрыть, отметить исполненным",
        basis: "design",
        evidence: "/proposals/:id/open, /votes, /close, /execute",
      },
      {
        text: "Ни кошелька, ни токена: голосовать можно обычным аккаунтом платформы",
        basis: "design",
        evidence: "аутентификация через общий JWT AEVION",
      },
    ],
    weLose: [
      {
        text: "Решение НЕ исполняется само: «исполнено» — это статус, который ставит администратор, а не действие в казне",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: POST /proposals/:id/execute требует роль администратора и переключает статус; ни казны, ни автоматического действия в модуле нет",
      },
      {
        text: "Нет веса голоса по доле и нет подписи кошельком — то, на чём стоит доверие к Snapshot",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
      {
        text: "Нет инструментов обсуждения: у Loomio и Decidim это половина продукта",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
    ],
    verdict:
      "Мы лучше для внутренних решений внутри платформы, где важна простота, а не бездоверие. Управлять казной и правами — Aragon; собирать голоса сообщества web3 — Snapshot.",
    surveyedAt: "2026-07-28",
    sources: ["src/routes/qchaingov.ts"],
  },

  {
    moduleId: "qpersona",
    module: "QPersona — страница-визитка по псевдониму",
    page: "/qpersona",
    category: "личные страницы и сборники ссылок",
    rivals: [
      { name: "Linktree", url: "https://linktr.ee", strength: "стандарт жанра: аналитика переходов, шаблоны, оплата и магазин прямо в странице" },
      { name: "about.me", url: "https://about.me", strength: "визитка с индексацией в поиске и понятной репутацией домена" },
      { name: "Notion / Carrd", url: "https://carrd.co", strength: "полная свобода вида страницы за те же пять минут" },
    ],
    weWin: [
      {
        text: "Псевдоним занимается один раз и по-настоящему: занятый alias не отдадут второму человеку ни в одной из ветвей хранения",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: проверка занятости стоит и в ветке Postgres, и в in-memory, плюс перехват нарушения уникальности в catch — три слоя на один инвариант",
      },
      {
        text: "Описание себя может собрать ИИ — не надо смотреть в пустое поле",
        basis: "design",
        evidence: "маршрут /personas/:alias/ai-bio",
      },
    ],
    weLose: [
      {
        text: "Нет аналитики переходов — того, ради чего Linktree и берут",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
      {
        text: "Нет ни шаблонов, ни редактора вида: страница выглядит так, как решили мы",
        basis: "design",
        evidence: "оформление задано модулем, настроек вида в API нет",
      },
      {
        text: "Ни оплаты, ни магазина внутри страницы, в отличие от Linktree",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
    ],
    verdict:
      "Мы лучше, когда визитка нужна внутри платформы и рядом с остальными модулями. Как самостоятельная страница-визитка Linktree сильнее по всем пунктам, кроме занятия псевдонима.",
    surveyedAt: "2026-07-28",
    sources: ["src/routes/qpersona.ts"],
  },

  {
    moduleId: "shadownet",
    module: "ShadowNet — симулятор приватной сети",
    page: "/shadownet",
    category: "обучение анонимности в сети",
    rivals: [
      { name: "Tor Project", url: "https://torproject.org", strength: "настоящая анонимная сеть, а не её модель" },
      { name: "EFF Surveillance Self-Defense", url: "https://ssd.eff.org", strength: "лучший учебный материал по моделям угроз, написанный юристами и инженерами" },
      { name: "Mullvad / любой VPN", url: "https://mullvad.net", strength: "реально меняет то, что видно о вас в сети" },
    ],
    weWin: [
      {
        text: "Модель угрозы выбирается и сразу превращается в маршрут: видно, как меняются задержки и оценка при 3–7 переходах",
        basis: "design",
        evidence: "каталог из четырёх моделей угроз плюс /route и /score",
      },
      {
        text: "Модуль сам называет себя симулятором — прямо в первых строках кода, а не мелким шрифтом",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: «This is an educational simulator, NOT a real VPN» в шапке файла",
      },
    ],
    weLose: [
      {
        text: "Ничего не защищает: это модель, а не сеть. Tor и VPN меняют реальность, мы — только показываем её устройство",
        basis: "design",
        evidence: "по природе продукта, и это зафиксировано в самом коде",
      },
      {
        text: "Глубина материала несопоставима с EFF: там годы работы и юридический контекст",
        basis: "public",
        evidence: "срез 2026-07-28",
      },
      {
        text: "Задержки переходов псевдослучайные, а не измеренные — числа иллюстрируют идею, а не сеть",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: задержки на переход генерируются, внешних измерений нет",
      },
    ],
    verdict:
      "Мы лучше как наглядный тренажёр «из чего складывается анонимность». Защищаться — Tor или VPN; разбираться глубоко — материалы EFF.",
    surveyedAt: "2026-07-28",
...

  {
    ...
    weLose: [
      ...
      {
        text: "Задачи НЕ приватны: у них нет владельца, поэтому любой может прочитать, изменить и удалить чужую задачу",
        basis: "measured",
        evidence: "проверено по коду 2026-07-28: в таблице deepsan_tasks нет колонки владельца, а удаление идёт запросом DELETE ... WHERE id = $1 без каких-либо условий и без входа",
      },
    ],
    verdict:
