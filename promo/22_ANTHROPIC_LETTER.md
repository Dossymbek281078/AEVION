...
| **НЕ просим долю Anthropic; партнёрство в доходе AEVION (49% партнёру / 51% основателю)** | Просить долю в Anthropic при их масштабе — абсурд. Партнёрская доля в доходе AEVION + интеграция = скромно и реалистично. Цены за долю нет. |
| **Деньги в конце, маленькие, возвратные** | $10M аванс «освободить основателя», возврат из его доли (основатель сохраняет 51%) → риск ~ноль, рост только вместе. |
