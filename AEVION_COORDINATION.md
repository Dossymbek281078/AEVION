...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T11:29:06.507Z — window=15min commits=6 branches=4 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 3 | coord, qcoreai | 7 minutes ago | docs(coord): add live WIP section — обновляется каждые 5 мин, anti-duplicatio… |
| `feat/hvac-cooling` | C:/Users/user/aevion-smeta-trainer | 1 | — | 7 minutes ago | chore: coord WIP — батч 24 закоммичен, батч 25 в работе |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | seo | 10 minutes ago | feat(seo): add JSON-LD SoftwareApplication/FinancialProduct/ResearchProject s… |
| `main` | C:/Users/user/aevion-core | 1 | coord | 13 seconds ago | chore(coord): WIP heartbeat — frontend-qcore alive 11:27 UTC |

_Last refresh: 2026-05-12T11:29:06.507Z_
