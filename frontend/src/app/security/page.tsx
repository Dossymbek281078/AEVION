...
const LAYERS = [
  ...
  },
  {
    ...
    accent: "#7dd3fc",
    body:
      "One AEVION account drives every module. JWT bearer with short lifetime + refresh; passkey-ready stack. Private data is never exposed through the public Trust Graph.",
    href: "/auth",
  },
  {
    n: "03",
