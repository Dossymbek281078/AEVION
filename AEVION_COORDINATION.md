...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T12:36:06.233Z — window=10min commits=23 branches=7 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 17 | scripts+docs, cyberchess, fintech, qsocial, devhub | 34 seconds ago | feat(scripts+docs): wait-for-deploy + MVP_CONCEPTS spec + hub-catalog regress… |
| `feat/capstone-cases` | (no worktree) | 1 | smeta-trainer | 3 minutes ago | feat(smeta-trainer): capstone-кейсы — коттедж/кафе/автомойка (батч 29) |
| `feat/qzone-block5-2026-05-12` | C:/Users/user/aevion-core/frontend-qcore | 1 | qmedia | 4 seconds ago | feat(qmedia): audio waveform visualization + mini equalizer on active track |
| `feat/sales-claims-tender` | C:/Users/user/aevion-smeta-trainer | 1 | — | 3 minutes ago | Merge pull request #246 from Dossymbek281078/feat/capstone-cases |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | ztide | 3 minutes ago | fix(ztide): reject meta > 4KB + reject array as meta in /events (consistent w… |
| `main` | C:/Users/user/aevion-core | 1 | seo | 3 seconds ago | feat(seo): OG images +6 cyberchess routes (edge-rendered 1200x630) |
| `origin/main` | (no worktree) | 1 | qnews | 27 seconds ago | feat(qnews): AI digest + summarize из Postgres |

_Last refresh: 2026-05-12T12:36:06.233Z_
