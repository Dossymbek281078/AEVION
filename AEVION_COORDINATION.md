...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T12:20:51.014Z — window=10min commits=13 branches=5 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 9 | coord, mvp, fintech, qjobs, cyberchess | 34 seconds ago | chore(coord): WIP heartbeat — frontend-qcore alive 12:19 UTC |
| `feat/lifts-smart-asbestos` | C:/Users/user/aevion-smeta-trainer | 1 | — | 5 minutes ago | Merge pull request #244 from Dossymbek281078/feat/safety-systems |
| `feat/safety-systems` | (no worktree) | 1 | smeta-trainer | 6 minutes ago | feat(smeta-trainer): инж. сети — безопасность объекта (АПС/СОУЭ + СКУД/CCTV +… |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | coord | 6 minutes ago | chore(coord): REQ-E — add QMedia + QFusionAI to openapiFintechSpec.ts (reques… |
| `main` | C:/Users/user/aevion-core | 1 | cyberchess | 30 seconds ago | feat(cyberchess): mobile responsive pass on /cpi/*, /economy, /training — med… |

_Last refresh: 2026-05-12T12:20:51.014Z_
