    ...
    <>
      ...
      <ProductPageShell>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 16px 80px" }}>
          ...
          {/* flexWrap обязателен: строка фильтров уровня не помещалась в телефон.
              Замер прода 31.08.2026 при ширине 390: кнопка «Продвинутый»
              (112px) выходила за свой же контейнер (303px) до отметки 440 —
              документ становился 440 против экрана 390, и страница ездила вбок.
              Соседняя строка фильтров категорий (выше) перенос уже имела:
              один автор, одно место, одна задача — и разное поведение. Это и
              есть признак недосмотра, а не решения. */}
