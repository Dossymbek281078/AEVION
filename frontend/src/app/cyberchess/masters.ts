...
export const MASTER_GAMES: MasterGame[] = [
  ...
  },
  {
    ...
    result: "1-0",
    blurb:
      "Самый знаменитый «мат Лежаля» — миниатюра 7 ходов, ставшая названием комбинационного приёма. Жертва ферзя ради 3 лёгких фигур и мата.",
    moves: [
      "e4","e5","Bc4","d6","Nf3","Bg4","Nc3","g6","Nxe5","Bxd1","Bxf7+","Ke7","Nd5#",
    ],
    notes: {
      8: "5.Nxe5! — Лежаль игнорирует висящего ферзя.",
      9: "5...Bxd1?? — алчность чёрных. Лучше было Bxe5.",
      12: "7.Nd5#! Финальный мат тремя лёгкими фигурами. Эпонимный пример.",
    },
    guessSide: "w",
    theme: "Sacrifice",
  },
  {
    ...
    result: "1-0",
    blurb:
      "Двойная жертва слонов — первая систематическая демонстрация приёма. Ласкер раздевает короля h7 и g7 двумя слонами, а затем ферзь и ладья доводят до выигрыша.",
    moves: [
      "f4","d5","e3","Nf6","b3","e6","Bb2","Be7","Bd3","b6","Nf3","Bb7",
      "Nc3","Nbd7","O-O","O-O","Ne2","c5","Ng3","Qc7","Ne5","Nxe5","Bxe5","Qc6",
      "Qe2","a6","Nh5","Nxh5","Bxh7+","Kxh7","Qxh5+","Kg8","Bxg7","Kxg7","Qg4+","Kh7",
    ...
    notes: {
      ...
      32: "17.Bxg7! — вторая жертва. Король абсолютно открыт.",
      34: "18.Qg4+ Kh7 19.Rf3 — третья фигура подключается к атаке.",
      42: "22.Qd7! — теперь Ласкер ловит слона b7 и материал отыгран с лихвой.",
    },
    guessSide: "w",
    theme: "Sacrifice",
  },
  {
    ...
    result: "0-1",
    blurb:
      "Знаменитый ход 23...Qg3!! — «золотая монета». Зрители якобы посыпали доску золотыми монетами после этого хода. Один из красивейших ходов в истории шахмат.",
    moves: [
    ...
    notes: {
      ...
      46: "23...Qg3!! — легендарный ход. Берётся пешка g3, тройная угроза, ферзь неприкосновенен (если 24.hxg3 Ne2+ и мат; 24.fxg3 Ne2+).",
      48: "24.hxg3 Ne2+ — конь и ладья доводят до мата. Левитский сдался.",
    },
    guessSide: "b",
    theme: "Sacrifice",
  },
  {
    ...
    result: "1-0",
    blurb:
      "Партия № 6 матча на первенство мира. Фишер сменил 1.e4 на 1.c4 и сыграл такой образцовый ферзевой гамбит, что Спасский после партии аплодировал стоя — невиданный жест в матчах за корону.",
    moves: [
      "c4","e6","Nf3","d5","d4","Nf6","Nc3","Be7","Bg5","O-O","e3","h6",
      "Bh4","b6","cxd5","Nxd5","Bxe7","Qxe7","Nxd5","exd5","Rc1","Be6","Qa4","c5",
      "Qa3","Rc8","Bb5","a6","dxc5","bxc5","O-O","Ra7","Be2","Nd7","Nd4","Qf8",
    ...
    notes: {
      ...
      72: "Серия размеренных манёвров — Фишер ничего не торопит, постепенно сжимает позицию.",
      78: "37.Rxf6! — наконец комбинационный удар. Чёрные не могут защитить короля.",
    },
    guessSide: "w",
    theme: "Strategy",
  },
  {
    ...
    white: "Louis Paulsen",
    black: "Paul Morphy",
    event: "1st American Chess Congress NYC",
    year: 1857,
    result: "0-1",
    blurb:
      "«Партия Морфи против Паульсена» — образец позиционной жертвы ферзя за слона. Морфи отдаёт ферзя на 17-м ходу ради вечной атаки лёгкими фигурами.",
    moves: [
      "e4","e5","Nf3","Nc6","Nc3","Nf6","Bb5","Bc5","O-O","O-O","Nxe5","Re8",
      "Nxc6","dxc6","Bc4","b5","Be2","Nxe4","Nxe4","Rxe4","Bf3","Re6","c3","Qd3",
      "b4","Bb6","a4","bxa4","Qxa4","Bd7","Ra2","Rae8","Qa6","Qxf3","gxf3","Rg6+",
      "Kh1","Bh3","Rd1","Bg2+","Kg1","Bxf3+","Kf1","Bg2+","Kg1","Bh3+","Kh1","Bxf2",
      "Qf1","Bxf1","Rxf1","Re2","Ra1","Rh6","d4","Be3",
    ],
    notes: {
      33: "17...Qxf3!! — позиционная жертва ферзя. Дальше атака идёт лёгкими фигурами.",
      36: "18...Rg6+ — Морфи последовательно водит белого короля к катастрофе.",
      52: "26...Re2 — все белые фигуры неактивны, чёрные доминируют материала меньше.",
    },
    guessSide: "b",
    theme: "Sacrifice",
  },
