...
export const alt = "AEVION CyberChess — экономика Chessy";
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 22, color: "#64748b", textAlign: "center", marginBottom: 52, maxWidth: 980 }}>
        Аукцион уроков · аренда тренеров · подписка на стримеров
      </div>
      ...
      <div style={{ position: "absolute", bottom: 40, display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <span style={{ fontSize: 14, color: "#475569" }}>aevion.app/cyberchess/economy</span>
      </div>
    </div>,
