        ...
        <section className="space-y-6">
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex3} onChange={(e) => setEx3(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="25000000" placeholder="25000000" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
