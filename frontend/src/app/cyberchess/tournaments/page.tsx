    ...
    >
      ...
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
        ...
        {t.realPlayers ? (
          ...
          // Пометка обязана быть НА образце, а не только на настоящем. Раньше
          // подписаны были только турниры с живыми игроками, а посевные не
          // несли ничего — и отличались от настоящих лишь отсутствием тега.
          // Отсутствие метки человек не читает как «выдумано»: наоборот, рядом
          // с честно подписанным соседом образец берёт его доверие. На проде
          // 12.08 таких в списке было 11 из 13, включая «Winter Arena #12» со
          // статусом «завершён» — то есть с результатами, которых не было.
