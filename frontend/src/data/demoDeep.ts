...
export const demoDeepSections: DeepSection[] = [
  {
    ...
    bullets: [
      "Auth → JWT in localStorage; same token works across all 40 modules.",
...
function buildCertificate(qrightId) {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Globus — GET /api/globus/projects (catalog of all 40 nodes with status and priority).",
    ],
  },
  {
    id: "threat-model",
  ...
  },
  {
    ...
    body: [
      "If you came for the narrative — the visual product showcase across all 40 nodes lives at /demo, and the investment thesis (TAM, network effects, defensibility, GTM, ARR trajectory) lives at /pitch. Both pages pull live data from the same backend you've been reading about above.",
    ...
    bullets: [
      "Visual product tour → /demo (40 nodes, live ecosystem pulse, 90-second pipeline).",
