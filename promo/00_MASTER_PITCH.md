...
**Цена сегодня — миллиард, траектория — триллион.** Мы оцениваем *семя* в $1.05B. Слой под деньгами, IP и AI-provenance при настоящей команде — это адресуемое пространство ≈ $1.5–2T к 2030 (см. Приложение B). Асимметрия и есть сделка: **участвовать мало и безопасно сейчас (1–10%) — или забрать весь двигатель ($1B / 95%); в любом случае вы рано.**
