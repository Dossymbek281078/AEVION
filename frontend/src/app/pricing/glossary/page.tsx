...
const TERMS: Term[] = [
  ...
  // Compliance
  { id: "soc2", abbr: "SOC 2", full: "Service Organization Control 2", category: "compliance", related: ["iso27001", "gdpr"], ru: "Аудит-стандарт AICPA для SaaS-платформ: Security, Availability, Processing Integrity, Confidentiality, Privacy. AEVION проходит сертификацию SOC 2 Type II (в процессе, Q3 2026).", en: "AICPA audit standard for SaaS: Security, Availability, Processing Integrity, Confidentiality, Privacy. AEVION is working toward SOC 2 Type II (in progress, Q3 2026)." },
  { id: "iso27001", abbr: "ISO 27001", full: "Information Security Management Systems", category: "compliance", related: ["soc2"], ru: "Международный стандарт для управления информационной безопасностью. AEVION проходит сертификацию ISO 27001 для Enterprise-tier (в процессе, Q4 2026).", en: "International standard for information security management. AEVION is working toward ISO 27001 for the Enterprise tier (in progress, Q4 2026)." },
  ...
  { id: "saas", abbr: "SaaS", full: "Software as a Service", category: "billing", ru: "Программное обеспечение как услуга. AEVION — multi-product SaaS с все модулими.", en: "Software as a Service. AEVION is a multi-product SaaS with every module." },
];
