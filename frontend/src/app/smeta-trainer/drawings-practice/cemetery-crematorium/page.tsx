...
export default function CrematoriumPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header style={{ top: "var(--aevion-header-h, 0px)" }} className="border-b border-slate-800/60 bg-slate-900/60 backdrop-blur sticky top-0 z-10">
        ...
        <section className="rounded-2xl bg-slate-900/40 border border-slate-800 p-6">
          ...
          <div className="mb-8 rounded-xl bg-slate-900/60 border border-slate-700/60 p-5">
            ...
            <input
              ...
              aria-label="Количество мест" placeholder="Количество мест"
