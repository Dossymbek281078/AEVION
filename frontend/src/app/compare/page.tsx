  ...
  return (
    <div style={{ background: "#0a121d", minHeight: "100vh", color: "#dbe6f3" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "28px 20px 60px" }}>
        ...
        {/* «Здесь не все модули» без объяснения читается как недоделка. Список
            причин превращает неполноту в осознанный выбор — и заодно не даёт
            следующей сессии заполнить пропуск по догадке. */}
        <div style={{ marginTop: 28, maxWidth: 860, color: "#5f7086", fontSize: 12, lineHeight: 1.6 }}>
          <p>
            Здесь не все модули AEVION, и это не недоделка. Набор появляется тогда, когда его есть чем
            подкрепить: наша колонка — прогоном, чужая — публикацией аналога. Заполнять по памяти ради
            полноты таблицы означало бы ровно то, против чего эта страница устроена.
          </p>
          <p style={{ marginBottom: 4 }}>Чего пока нет и почему:</p>
          <ul style={{ margin: 0, paddingLeft: 18 }}>
            <li>
              <b style={{ color: "#93a4bd" }}>QTrade</b> — из кода не следует, чем он является для сравнения
              (реестр счетов и переводов без признаков симулятора). Пока не ясно, с кем его корректно
              сравнивать, набора не будет.
            </li>
            <li>
              <b style={{ color: "#93a4bd" }}>Банк</b> — финтех-граница уже показана на QPayNet; отдельный
              набор добавим, только если он скажет что-то новое, а не повторит ту же мысль.
            </li>
            <li>
              <b style={{ color: "#93a4bd" }}>Constitution, QCoreAI и остальные</b> — очевидного аналога, с
              которым сравнение было бы честным, мы пока не назвали.
            </li>
          </ul>
        </div>
      </div>
