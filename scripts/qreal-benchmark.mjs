...
//
//   market — опционально: клипы чужого продукта (Higgsfield и т.п.), положенные
//            руками. Судятся той же панелью, но в отчёте помечены как
//            confounded: там другая базовая модель, и дельта смешивает
//            «наша режиссура» с «их модель». Для маркетинга — не для доказательства.
//
