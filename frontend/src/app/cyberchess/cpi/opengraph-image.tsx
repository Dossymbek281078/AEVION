...
export const alt = "AEVION CyberChess — CPI Chess Rating";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function Image() {
  const chips = [
    { name: "Точность", color: "#a78bfa", icon: "🎯" },
    { name: "Время", color: "#a78bfa", icon: "⏱" },
    { name: "Мат-видение", color: "#a78bfa", icon: "💀" },
    { name: "Бриллианты", color: "#a78bfa", icon: "💎" },
  ];
  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ position: "absolute", bottom: 40, display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <span style={{ fontSize: 14, color: "#475569" }}>aevion.app/cyberchess/cpi</span>
      </div>
    </div>,
