...
export const SYM: Record<SymbolId, SymbolToken> = {
  play:        make("play",        "Игра",          "PLY", "#059669", "rgba(5,150,105,0.10)",   "#10b981", "#059669", "rgba(5,150,105,0.32)",  "Сыграть партию против ИИ или с другом"),
  ...
  coach:       make("coach",       "Тренер",        "CCH", "#7c3aed", "rgba(124,58,237,0.10)",  "#a78bfa", "#7c3aed", "rgba(124,58,237,0.32)", "ИИ-тренер, разбор партии, база знаний"),
