...
const ZHARGON_RU =
  /(^|[^а-яё])(пазл|лидерборд|провизорн|опт-ин|бэкенд|бекенд|фронтенд|эндпоинт|деплой|пайплайн|фолбэк|поллинг|кэш|стейт|билд|стрик|буст)(а|у|е|ом|ов|ам|ами|ах)?([^а-яё]|$)/i;
