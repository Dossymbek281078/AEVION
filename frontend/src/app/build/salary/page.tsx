      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <form onSubmit={search} className="flex gap-2 mb-4">
          <input
            ...
            aria-label={t("build.salary.search.specialtyPlaceholder")} placeholder={t("build.salary.search.specialtyPlaceholder")}
          ...
          <input
            ...
            aria-label={t("build.salary.search.cityPlaceholder")} placeholder={t("build.salary.search.cityPlaceholder")}
