    ...
    <main style={styles.page}>
      <div style={styles.wrap}>
        ...
        <section style={styles.section}>
          ...
          {/*
            Число живых модулей — из реестра, а не цифрой. Здесь стояло «29» при
            36 живых: страница, которую первой видит холодный зритель, занижала
            платформу на семь модулей. Устаревший счётчик всегда МЕНЬШЕ правды —
            растёт реестр, а литерал стоит на месте, — поэтому на глаз он выглядит
            правдоподобно и не ловится. Коммит 717c5b494 чинил счётчики на этой же
            странице, но заголовок карточки пропустил.
          */}
          <LinkCard
            href={keep("/explore")}
