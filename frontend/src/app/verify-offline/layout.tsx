...
export const metadata: Metadata = {
  ...
  description: "Drop a verification bundle and your browser replays every cryptographic step locally — without contacting AEVION.",
};

export default function VerifyOfflineLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
