...
export const projects: GlobusProject[] = [
  ...
  },
  {
    ...
    description:
      "Базовый ИИ-движок для всех Q-проектов: оркестрация, агенты, интеллектуальные подсистемы.",
    kind: "core",
    status: "in_progress",
    priority: 1,
    tags: ["ai", "engine", "core"],
  ...
  },
  {
    ...
    description:
      "Мультичат с параллельными подчатиками (агентами) для разных задач: код, финансы, видео, IP и др.",
    kind: "product",
    status: "planning",
    priority: 2,
    tags: ["ai", "chat", "agents"],
  ...
  // ===== IP / LEGAL (FIRST WAVE) =====
  {
    ...
    description:
      "Система независимой правовой защиты цифровых объектов: регистрация идей/контента и подтверждение авторства.",
    kind: "core",
    status: "in_progress",
    priority: 1,
    tags: ["ip", "legal", "core"],
  ...
  },
  {
    ...
    description:
      "Цифровая подпись и проверка целостности артефактов для всех продуктов AEVION.",
    kind: "core",
    status: "in_progress",
    priority: 1,
  ...
  },
  {
    ...
    description:
      "Электронное патентное бюро AEVION: оформление и выдача цифровых сертификатов прав.",
    kind: "service",
    status: "planning",
    priority: 1,
  ...
  // ===== CHESS / GAMING (FIRST WAVE MVP) =====
  {
    ...
    description:
      "Шахматная платформа нового поколения: обучение, заработок, командные механики, античит.",
    kind: "product",
    status: "planning",
    priority: 2,
