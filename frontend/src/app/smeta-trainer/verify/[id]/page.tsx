        ...
        {validFormat ? (
          <div className="mt-6">
            ...
            <p className="text-sm text-slate-600 mt-3 leading-relaxed">
              Номер имеет формат, который выдаёт модуль AEVION
              «Сметный тренажёр РК». Это проверка ФОРМАТА, а не подлинности:
              реестра выданных сертификатов страница не спрашивает, поэтому
              подтвердить, что такой сертификат действительно выдан, она не
              может. Подтверждение подлинности появится вместе с подписью
              сертификата на бэкенде.
            </p>
