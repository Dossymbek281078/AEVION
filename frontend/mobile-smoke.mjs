...
// Страницы очереди запуска добавлены 19.08.2026. Раньше здесь были только
// денежные и инвесторские, а посадочные модулей — те, куда ведёт трафик
// роликов, — не проверялись на телефоне вовсе. Между тем открывать их будут
// почти только с телефона, и «читаемость на телефоне» это ворота запуска.
const PAGES = [
  "/go?c=ig", "/shop?c=ig", "/longevity", "/", "/acquire", "/investor", "/pricing",
  "/cyberchess/launch", "/bureau/launch", "/devhub/launch", "/multichat-engine/launch",
  "/qright",
];
