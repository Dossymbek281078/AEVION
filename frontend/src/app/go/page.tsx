  ...
  return (
    <main style={styles.page}>
      <div style={styles.wrap}>
        ...
        {/* Единственная ссылка, добавленная к сфокусированной странице, и стоит
            она ПОСЛЕ всех предложений — сразу перед сноской. Человек с рекламы
            приходит с вопросом «чем это лучше того, чем я пользуюсь»; если
            ответа нет нигде, он уходит искать его сам и не возвращается. Выше
            по странице такая ссылка соперничала бы с покупкой, здесь — ловит
            того, кто иначе просто закрыл бы вкладку. */}
        <div style={styles.aside}>
          Сомневаетесь, зачем это вам?{" "}
          <a href={keep("/compare")} style={styles.link}>
            Сравнение с аналогами
          </a>{" "}
          — там названо и то, в чём мы слабее.
        </div>
