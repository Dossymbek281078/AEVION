...
export const metadata: Metadata = {
  title: "Launch status",
  description: "Real-time состояние production-инфраструктуры AEVION, обновление раз в 60 секунд.",
};

export default function LaunchStatusLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
