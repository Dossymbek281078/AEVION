...
async function main() {
  ...
  assert(cityIds.includes("astana") && cityIds.includes("nyc") && cityIds.includes("tokyo") && cityIds.includes("singapore") && cityIds.includes("amsterdam") && cityIds.includes("berlin") && cityIds.includes("vienna"), "registry has astana + nyc + tokyo + singapore + amsterdam + berlin + vienna", cityIds.join(","));
