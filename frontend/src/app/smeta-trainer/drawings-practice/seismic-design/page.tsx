          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <label className="flex flex-col">
                ...
                <input value={ex2H} onChange={(e) => setEx2H(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="400" placeholder="400" />
              </label>
              <label className="flex flex-col">
                <span className="text-slate-400 text-xs mb-1">Длина пояса L, м</span>
                <input value={ex2L} onChange={(e) => setEx2L(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="24" placeholder="24" />
              </label>
            </div>
            <div className="flex flex-wrap gap-3 mt-4">
...
На 2 этажа = 2.88 м³ бетона + ≈170 кг арматуры на здание.`}
          ...
          <div className="border border-slate-800 rounded-xl p-5 bg-slate-900/40">
            ...
            <label className="flex flex-col text-sm max-w-xs">
              ...
              <input value={ex4Area} onChange={(e) => setEx4Area(e.target.value)} type="number" className="bg-slate-950 border border-slate-700 rounded px-3 py-2 text-slate-100" aria-label="1500" placeholder="1500" />
            </label>
            <div className="flex flex-wrap gap-3 mt-4">
