...
export const ENDGAMES:Endgame[]=[
  ...
  {name:"Два слона против короля",fen:"8/8/4k3/8/2B5/8/1B2K3/8 w - - 0 1",goal:"Win",side:"w",hint:"Слоны разнопольные — только такая пара и ставит мат. Ставь их на соседние диагонали и гони короля в угол, король помогает. Занимает 15-20 ходов.",reward:25},
