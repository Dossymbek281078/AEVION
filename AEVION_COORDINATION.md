...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T12:22:25.895Z — window=10min commits=18 branches=5 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 14 | cyberchess, api-explorer, sdk, smoke, coord | 25 seconds ago | feat(cyberchess): F2 phase-2 multiPV + depth UI + PiP UX polish |
| `feat/lifts-smart-asbestos` | C:/Users/user/aevion-smeta-trainer | 1 | — | 7 minutes ago | Merge pull request #244 from Dossymbek281078/feat/safety-systems |
| `feat/safety-systems` | (no worktree) | 1 | smeta-trainer | 8 minutes ago | feat(smeta-trainer): инж. сети — безопасность объекта (АПС/СОУЭ + СКУД/CCTV +… |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | coord | 7 minutes ago | chore(coord): REQ-E — add QMedia + QFusionAI to openapiFintechSpec.ts (reques… |
| `main` | C:/Users/user/aevion-core | 1 | sdk | 11 seconds ago | test(sdk): @aevion/catalog-client — 43 vitest smoke tests |

_Last refresh: 2026-05-12T12:22:25.895Z_
