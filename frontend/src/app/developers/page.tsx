...
const APIS = [
  {
    ...
    endpoints: ["POST /api/qright/objects", "GET /api/qright/objects/:id", "POST /api/qright/verify"],
  },
  {
    name: "QSign",
    color: "#a78bfa",
    ...
    endpoints: ["POST /api/qsign/sign", "POST /api/qsign/verify", "POST /api/qsign/v2/sign/batch", "POST /api/qsign/file"],
  },
  {
    name: "Bureau",
    color: "#f472b6",
  ...
  },
  {
    ...
    endpoints: ["POST /api/qcoreai/chat", "GET /api/qcoreai/sessions", "GET /api/qcoreai/providers", "GET /api/qcoreai/health"],
  },
  {
    name: "Multichat",
    color: "#c084fc",
