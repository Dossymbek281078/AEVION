...
// свою ветку — и /health продолжил уверенно называть МОЙ коммит, которого на
// проде уже не было. Проверка сборки отвечала бодрым «совпадает», пока прод
// работал на коде двухнедельной давности.
//
