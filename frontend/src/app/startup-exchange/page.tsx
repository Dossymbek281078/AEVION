      ...
      <ProductPageShell>
        ...
        >
          ...
          <MvpConceptBoard
            ...
            // Записи робота сборки не показываем — замер 09.09.2026: в доске
            // лежали ровно три записи, все с автором `ci` («smoke 20260519…»,
            // обоснование «auto-smoke»), возрастом 112–113 дней. Блок зовётся
            // «Последние», то есть обещает свежесть. После фильтра посетитель
            // увидит готовое «Пока пусто. Стань первым, кто поделится».
            hideAuthors={["ci"]}
            accent="amber"
