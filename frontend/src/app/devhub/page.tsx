      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 16px" }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 13.5, color: "#99f6e4", marginBottom: 14, lineHeight: 1.5 }}>
            {/* Порядок здесь — обещание, а не украшение. Раньше строка ставила
                Visual Edit сразу после превью, а он у стека по умолчанию (`next`)
                включается ПОСЛЕ деплоя: до деплоя вкладка показывает «сначала
                разверните проект». Правка кликами сразу доступна только на
                статике. Обещать порядок, которого нет, дороже, чем назвать
                условие: человек ищет кнопку, не находит и считает, что сломано. */}
            ИИ создаст проект, напишет код, покажет живое превью и диффы. Дальше — проси изменения
            в чате, генерируй картинки и звук, деплой в один клик. После деплоя — правь кликами
            прямо на странице (Visual Edit; на статике доступен сразу).
          </div>
