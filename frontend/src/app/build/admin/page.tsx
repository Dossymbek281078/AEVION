  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <NavCard href="/build/admin/ai-search-log" title="AI search accuracy" body="How often the checker agent had to correct the parser on real natural-language searches." />
