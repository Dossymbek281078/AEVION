 ...
 *
 * ГРАНИЦА. Сторож видит обращения вида `t("...")` и `tp("...")` с
...
describe("страницы не просят у словаря того, чего в нём нет", () => {
  ...
  test("ни одна страница не просит несуществующий ключ", () => {
    ...
    expect(обращений, "обращений к словарю подозрительно мало — разбор сломан").toBeGreaterThan(300);
    expect(
      пропавшие,
