        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <a
              ...
              className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs font-semibold text-emerald-200 hover:bg-emerald-500/20 min-h-[36px] inline-flex items-center"
            >
              ⬇ Resume PDF
            </a>
            <Link
              ...
              target="_blank"
              className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-slate-200 hover:bg-white/10 min-h-[36px] inline-flex items-center"
