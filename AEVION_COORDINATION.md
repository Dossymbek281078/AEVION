...
Поведение НЕ менялось: сверка ветки требует рабочего каталога вызова, а получает
ли его хук — выяснится по этим же записям. Менять защиту на догадке хуже, чем
оставить её громкой.
