...
const TERMS: Term[] = [
  ...
  { id: "saas", abbr: "SaaS", full: "Software as a Service", category: "billing", ru: "Программное обеспечение как услуга. AEVION — multi-product SaaS с 43 модулями.", en: "Software as a Service. AEVION is a multi-product SaaS with 43 modules." },
];
