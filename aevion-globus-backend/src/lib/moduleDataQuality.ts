...
import { CITY_VIENNA } from "../routes/qskyway.city.vienna";
import { CITY_ZURICH } from "../routes/qskyway.city.zurich";
...
const qskywayProvider: Provider = () => {
  ...
  for (const c of [CITY, CITY_NYC, CITY_TOKYO, CITY_SINGAPORE, CITY_AMSTERDAM, CITY_BERLIN, CITY_VIENNA, CITY_ZURICH]) {
