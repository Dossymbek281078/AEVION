...
> Аудитория: стратегический партнёр (в первую очередь Anthropic).
> Цель документа: довести до решения **«готов рассматривать партнёрство»**.
...
**Когда ИИ-инструменты становятся товаром, дефицитом становится не инструмент, а место, где живёт пользователь.** Несколько структур уже дают ИИ «для всего» — следующий слой не сотня вкладок, а самодостаточные среды-«планеты», внутри которых происходит вся работа человека. Кто построит первую связную — владеет всей сессией пользователя. **AEVION — первая такая планета, на базе Anthropic:** внутри её ареала есть всё, и уходить никуда не нужно. Открытая по дизайну — можно подключить Amazon и другие площадки, можно строить свои под-миры (пользователи или сам Anthropic). **Одна модель безопасности масштабируется на любого участника — от одного человека, ИП и ТОО до целой школы, клиники, банка и государства: у каждого свой запечатанный суверенный контур, между ними только аттестации.** Полный тезис — `24_PLANET_THESIS.md`, экосистема участников — `28_ECOSYSTEM_TENANTS.md`. **И главное про деньги: когда инструмент (модели/агенты) коммодитизируется до бесплатного, платят не за инструмент, а за место, где живёшь, — а место держит подписку, привычную потребителю. Планета берёт членскую плату там, где модель в одиночку не может; это устойчивая рекуррентная выручка поверх любой коммодити-модели — и причина смещать вектор в завлечение пользователей в такие экосистемы уже сейчас.**

А наполняют эту планету три сошедшиеся волны.
...
**Мы предлагаем партнёрство: $10M возвратным авансом + доход проекта 51% основатель / 49% партнёр, основатель остаётся Chief Idea Officer.** Условия — на финальном слайде.
...
**Единое предложение — партнёрство, не выкуп.** $10M **возвратным авансом** + доход проекта делится **51% основатель / 49% партнёр** (стартовая рамка). Основатель остаётся **Chief Idea Officer** — автором и двигателем следующих идей, с мажоритарной долей. Партнёр платит в основном ресурсами (compute, инженеры, дистрибуция, бренд) + небольшой возвратный аванс. Бренд AEVION сохраняется, токен AEV вынесен из периметра. Полные условия — в `02_DEAL_TERMS.md`.

**Сегодня — семя, траектория — триллион.** Слой под деньгами, IP и AI-provenance при настоящей команде — это адресуемое пространство ≈ $1.5–2T к 2030 (см. Приложение B). Асимметрия и есть смысл партнёрства: **войти ресурсами и небольшим возвратным авансом сейчас, а апсайд от роста разделить — основатель удержан как двигатель, партнёр получает 49% дохода растущей экосистемы.**
...
> **Единое предложение — партнёрство, не выкуp.**
>
> $10M **возвратным авансом** (смысл — освободить основателя от текущих компаний под фул-тайм на идеи)
...
**Калибровка:** AEVION = «Plaid + GitHub + ранний Stripe + Figma + on-chain notary» в одном контуре. Эти сделки даны для понимания масштаба категории — в нашем предложении партнёр входит ресурсами и возвратным авансом, а апсайд от роста делится (49% у партнёра).
...
**Сумма пересечений (не сложение):** ≈ $1.5-2T реалистичного «адресуемого пространства» к 2030 году. AEVION претендует на 0.05-0.1% этого пространства за 5 лет — это $750M-$2B ARR run-rate. **Это и есть апсайд, который партнёрство делит: 49% дохода у партнёра, 51% у основателя.**
