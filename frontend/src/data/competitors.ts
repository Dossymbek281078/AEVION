...
export const COMPARE_ROWS: CompareRow[] = [
  ...
  {
    module: "healthai",
    title: "HealthAI — отслеживание биомаркеров",
    ...
    sources: [
      { label: "Function Health 2026: $365 в год, два забора, 100+ показателей", url: "https://www.bloodtestcomparison.com/function-health" },
      { label: "InsideTracker против Function Health: цены и состав", url: "https://finvsfin.com/function-health-vs-superpower-vs-insidetracker-vs-lifeforce/" },
    ],
  },
  {
    module: "smeta-trainer",
    title: "Тренажёр сметного дела РК",
    ...
    sources: [
      { label: "Лицензия АВС-4 в Казахстане: от 330 000 ₸, обновление 280 000 ₸", url: "https://pro.cad.kz/abc4" },
      { label: "Курсы по сметному делу в АВС — около 60 000 ₸", url: "https://asdpro.kz/p47750389-kursy-avs-smetnye.html" },
    ],
  },
  {
    module: "qmedia",
