...
> «AEVION = Plaid + GitHub + ранний Stripe + Figma + on-chain notary. Но это не выкуп. Я предлагаю партнёрство: вы входите в основном ресурсами, я остаюсь за рулём как Chief Idea Officer, и вам достаётся 49% апсайда по факту роста.»
...
> **Партнёрство, не выкуп. Основатель не уходит.**
> **$10M возвратным авансом** от партнёра — чтобы освободить основателя на фул-тайм для идей
> Аванс возвращается из доли основателя по мере роста
...
> Основатель = **Chief Idea Officer** · бренд AEVION сохраняется
> Токен AEV вынесен из периметра (ring-fenced) · эксклюзивность 60 дней · DD 30 дней
...
> «Это партнёрство, а не покупка. Я не ухожу — я остаюсь Chief Idea Officer и двигаю следующие 30 модулей. Вы входите ресурсами и небольшим возвратным авансом, а 49% апсайда растёт вместе с проектом. Если LOI на этих условиях — подписываем в течение пяти рабочих дней.»
