...
async function main() {
  ...
  assert(cityIds.includes("astana") && cityIds.includes("nyc") && cityIds.includes("tokyo") && cityIds.includes("singapore") && cityIds.includes("amsterdam"), "registry has astana + nyc + tokyo + singapore + amsterdam", cityIds.join(","));
