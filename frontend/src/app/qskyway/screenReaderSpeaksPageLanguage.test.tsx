...
const KNOWN_RUSSIAN_LABELS = [
  // Строка «Источник ограничения» УБРАНА 08.09.2026: подпись переведена через
  // словарь (ключ reg.tip.label в ru/en/kk), как и обёртка вокруг неё.
  // Опасение из таблицы выше — «правка разъедется с другими страницами
  // компонента» — не подтвердилось: компонент уже звал useI18n для своих
  // ярлыков, и подпись была единственной зашитой строкой. Храповик назвал
  // починку сам, как и в случае «Провенанса данных» 02.09.
