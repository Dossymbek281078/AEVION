...
async function main() {
  ...
  assert(cityIds.includes("astana") && cityIds.includes("nyc") && cityIds.includes("tokyo") && cityIds.includes("singapore") && cityIds.includes("amsterdam") && cityIds.includes("berlin"), "registry has astana + nyc + tokyo + singapore + amsterdam + berlin", cityIds.join(","));
