...
<!-- WIP-AUTO:BEGIN -->
<!-- regenerated 2026-05-12T12:12:00.563Z — window=10min commits=13 branches=5 -->
...
|---|---|---:|---|---|---|
| `(detached)` | (no worktree) | 9 | qstore, qmedia, coord, qlearn, qnews | 2 minutes ago | fix(qstore): restore missing closing bracket in sellers endpoint after chart … |
| `feat/safety-systems` | C:/Users/user/aevion-smeta-trainer | 1 | — | 5 minutes ago | Merge pull request #243 from Dossymbek281078/feat/comm-gas-air |
| `feat/zone-cleanup-2026-05-12` | C:/Users/user/aevion-build | 1 | qmedia-smoke | 2 minutes ago | test(qmedia-smoke): assert backend rejects javascript: and ftp:// URLs |
| `main` | C:/Users/user/aevion-core | 1 | qsocial | 0 seconds ago | feat(qsocial): notifications Postgres path + fix(coord): restore clean COORDI… |
| `origin/main` | (no worktree) | 1 | coord | 2 minutes ago | chore(coord): BROADCAST #5 — Rule 6 «Each block ends with What's Next proposals» |

_Last refresh: 2026-05-12T12:12:00.563Z_
