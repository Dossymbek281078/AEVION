...
export const LANG_KEY_COUNT: Record<Lang, number> = {
  ...
  // 16.09: ценовая политика «тариф = срок» — ключи pricing.* переписаны (сняты period/annual/bundles,
  // заведены сроки и блок приложений), moduleChip.* и constitution.* правлены. Числа посчитаны,
  // а не на глаз: ru 7425, en 7425, kk 7384.
  ru: 7425,
  en: 7425,
  kk: 7384,
  de: 134,
