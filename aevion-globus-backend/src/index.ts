...
// Author payout ledger — /api/qright/royalties + /api/qright/royalties.csv.
// Lives under qright/* but is a separate router so the patent surface and
// the royalty feed can be deployed/iterated independently.
