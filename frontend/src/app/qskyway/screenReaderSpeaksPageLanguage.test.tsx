...
const KNOWN_RUSSIAN_LABELS = [
  ...
  // Строка «Провенанс данных» УБРАНА 02.09.2026: мерж состоялся, подпись
  // приходит из словаря. Условие исчезновения было записано в самом списке —
  // храповик назвал её сам, отдельной работы не потребовалось.
