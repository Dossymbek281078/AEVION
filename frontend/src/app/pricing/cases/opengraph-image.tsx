...
export const alt = "AEVION — Customer stories with metrics";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            До / после: банки, юр. фирмы, стартапы, госсектор. Цифры, а не маркетинг.
          </p>
        </div>

        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", gap: 32 }}>
            <Stat value="−73%" label="время подписи" />
            <Stat value="$2.3M" label="экономии в год" />
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      <span style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.02em", color: "#fbcfe8" }}>{value}</span>
