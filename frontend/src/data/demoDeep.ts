...
export const demoDeepSections: DeepSection[] = [
  {
    ...
    body: [
      ...
      "Bureau is the legal layer. It composes a QRight entry, its QSign signature and (when present) its Quantum Shield record into a signed, timestamped PDF certificate citing six international frameworks (Berne, WIPO, TRIPS, eIDAS, ESIGN, KZ Digital Sig). The PDF is served from /api/pipeline/certificate/{id}/pdf and can be re-validated by any third party at /verify/{id}.",
