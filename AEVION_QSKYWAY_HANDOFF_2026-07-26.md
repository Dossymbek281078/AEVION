...
Сделано в том же окне:  получил текущий смысл (3), 
теперь считает только настоящие фиды (1), фронт читает новое поле с откатом на
старое (пока прод не выкачен), тест в  держит оба числа
и то, что первое строго больше второго. tsc обеих частей чист.
