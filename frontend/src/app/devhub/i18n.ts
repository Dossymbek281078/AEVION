...
const EN = {
  ...
  "caps.off.zone": "the keys are in place, but the DNS zone is not ready at its provider — issued addresses do not resolve",
...
const RU: Record<Key, string> = {
  ...
  "caps.off.zone": "ключи заданы, но зона DNS не готова у поставщика — выданные адреса не разрешаются",
...
const KK: Record<Key, string> = {
  ...
  "caps.off.zone": "кілттер бар, бірақ DNS аймағы провайдерде дайын емес — берілген мекенжайлар шешілмейді",
