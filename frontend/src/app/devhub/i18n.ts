...
const EN = {
  ...
  "value.priceNote": "Prices are the services' public tariffs as of July 2026. We don't promise \"many times cheaper\": the win is not the subscription price — it's that each step's result lands in the same project as the next one.",
...
const RU: Record<Key, string> = {
  ...
  "value.priceNote": "Цены — публичные тарифы сервисов на июль 2026. Мы не обещаем «в разы дешевле»: выигрыш здесь не в цене подписки, а в том, что результат одного шага сразу лежит в том же проекте, что и следующий.",
...
const KK: Record<Key, string> = {
  ...
  "value.priceNote": "Бағалар — сервистердің 2026 жылғы шілдедегі жария тарифтері. «Бірнеше есе арзан» деп уәде бермейміз: ұтыс жазылым бағасында емес — әр қадамның нәтижесі келесісімен бір жобада жатады.",
