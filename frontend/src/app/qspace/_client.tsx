      ...
      */}
        ...
        <aside style={S.panel}>
          ...
          {selectedUid !== null && (
            <div style={S.selBox}>
              ...
              <p style={S.hint}>
                Предмет можно перетаскивать мышью прямо в 3D — так быстрее.
                Но и без мыши доступно всё: предмет выбирается кнопкой в списке
      ...
      <footer style={S.footer}>
        ...
        <p>
          ...
          типовая, а не из чертежа; расстановка мебели идёт только мышью;
