...
//
// ЦЕНЫ ЗДЕСЬ НЕТ, И ЭТО НЕ УПУЩЕНИЕ. На момент записи в прайсе (MODULES_PRICING)
// записи devhub не было вовсе, в магазине позиции не было, а политика платного
// доступа модуля не знала — проверено на проде. Назвать цену значило бы отправить
// человека к кнопке, которой не существует. С 15.09.2026 DevHub — одно из пяти
// приложений лестницы сроков; цену сюда добавлять только из @/lib/termPricing и
// после того, как касса на новую лестницу проверена на проде.
...
export const metadata: Metadata = {
  ...
  title: { absolute: "AEVION DevHub — ранний доступ" },
